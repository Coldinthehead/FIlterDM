...
public class BlockTemplateManagerTests
{
    ...
    public void SetTemplate_ShouldRaiseEvent()
    {
        ...
        testBlock.AddRule(new RuleDetailsViewModel(new(), new(new()), new ViewModels.EditPage.Managers.RuleTemplateManager(new RuleTemplateService(new RuleTemplateRepository())), new(), new()));
